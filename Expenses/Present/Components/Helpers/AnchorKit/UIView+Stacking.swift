...
protocol StackViewProtocol {
    @discardableResult
    func VStack(_ views: UIView..., spacing: CGFloat, alignment: UIStackView.Alignment, distribution: UIStackView.Distribution) -> UIStackView
    @discardableResult
...
extension StackViewProtocol where Self: UIViewController {}
...
extension StackViewProtocol where Self: UIView {
    ...
    @discardableResult
    internal func VStack(_ views: UIView..., spacing: CGFloat = 0, alignment: UIStackView.Alignment = .fill, distribution: UIStackView.Distribution = .fill) -> UIStackView {
        return _stack(.vertical, views: views, spacing: spacing, alignment: alignment, distribution: distribution)
    }
    
    @discardableResult
    internal func HStack(views: UIView..., spacing: CGFloat = 0, alignment: UIStackView.Alignment = .fill, distribution: UIStackView.Distribution = .fill) -> UIStackView {
        return _stack(.horizontal, views: views, spacing: spacing, alignment: alignment, distribution: distribution)
    }
    
    @discardableResult
    internal func withSize<T: UIView>(_ size: CGSize) -> T {
    ...
    @discardableResult
    internal func withHeight(_ height: CGFloat) -> UIView {
        translatesAutoresizingMaskIntoConstraints = false
    ...
    @discardableResult
    internal func withWidth(_ width: CGFloat) -> UIView {
        translatesAutoresizingMaskIntoConstraints = false
